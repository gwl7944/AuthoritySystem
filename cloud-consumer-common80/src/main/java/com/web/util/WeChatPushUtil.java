...
public class WeChatPushUtil {
    ...
    public static String weChatGetOpenid(String appid,String secret,String js_code){

        //通过刚才获取到的access_token去获取所有用户的openId
        String str = sendGet("https://api.weixin.qq.com/sns/jscode2session","appid="+appid+"&secret="+secret+"&js_code="+js_code+"&grant_type=authorization_code");
        return str;
    }
    ...
    public static String weChatPush(String data){
        ...
        String str1 = sendGet("https://api.weixin.qq.com/cgi-bin/token","grant_type=client_credential&appid=wx111e40902b22b38e&secret=66252beaa3351ddd1bdf18404baf3953");
        //将字符串转化为map集合
        JSONObject parseObject1 = JSONArray.parseObject(str1);
